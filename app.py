...
def super_simple():
    return jsonify(message='Hello from the Planetary API with attempt 4', name='Marcin'), 200
...
def add_planet():
    ...
    if test:
        ...
        db.session.commit()
        return jsonify(message="You've added a new planet."), 201
...
def remove_planet(planet_id: int):
    ...
    if planet:
        ...
        return jsonify(message="That planet is not in the table."), 404
